...
while True:
    ...
    # if command_start== "start":
        ...
        time.sleep(3)
        print('GO !')
        playsound("C:/Users/user/Downloads/playball.mp3") #sound for START
        ...
        while (count< balls): 
            ...
            if (hit!= 0 or  (time1-time0)>=timing):
                ...
                # if (count<=balls-1):
                    time.sleep(wait1)
                    playsound("C:/Users/user/Downloads/nextball.mp3") #sound for next ball
                    ser0.write("brush_con".encode())
                    ser0.write("*".encode())
                ...
                if ((time1-time0)>timing):
                    ...
                    ser1.write("*".encode())
                    playsound("C:/Users/user/Downloads/miss.mp3") #sound for over time 
                time0 = time.perf_counter()   # begining 
                time1 = time0   # current time
                time_count=0
                hit=0
        ...
        # command = ser1.readline().decode().strip() #search for start command
        # a= input("input : ") 